...
exports.criticalIssuesEmail = criticalIssuesEmail;
const base_1 = require("./base");
const APP_URL = process.env.NEXT_PUBLIC_APP_URL || "https://siteproof.nl";
function criticalIssuesEmail(data) {
    ...
    ${(0, base_1.emailButton)("Bekijk alle issues", `${APP_URL}/dashboard/scans/${data.scanId}`)}
  `;
    return {
