...
exports.subscriptionConfirmEmail = subscriptionConfirmEmail;
...
function subscriptionConfirmEmail(data) {
    const content = `
    ...
    ${(0, base_1.emailButton)("Ga naar je dashboard", `${APP_URL}/dashboard`)}
...
function subscriptionCancelledEmail(data) {
    const content = `
    ...
    ${(0, base_1.emailButton)("Abonnement herstellen", `${APP_URL}/dashboard/settings/billing`)}
  `;
    return {
