...
function scoreDropEmail(data) {
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 8px; margin-bottom: 24px;">
      <tr>
        <td style="padding: 24px; text-align: center; width: 45%;">
          ...
          ${(0, base_1.scoreCircle)(data.previousScore)}
        </td>
        ...
        <td style="padding: 24px; text-align: center; width: 45%;">
          ...
          ${(0, base_1.scoreCircle)(data.currentScore)}
        </td>
      </tr>
    </table>
    ...
    ${(0, base_1.emailButton)("Bekijk issues", `${APP_URL}/dashboard/scans/${data.scanId}`)}
